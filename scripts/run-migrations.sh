...
MIGRATIONS=(
  ...
  "023_market_events.sql"
  "024_koru_ewy_indicators.sql"
)
...
echo "5. 023_market_events.sql       - 시장 이벤트 테이블 + market_score_history 확장"
echo "6. 024_koru_ewy_indicators.sql - KORU/EWY 한국 ETF 지표 가중치 추가"
echo ""
echo "위 순서대로 실행해주세요."
echo ""
