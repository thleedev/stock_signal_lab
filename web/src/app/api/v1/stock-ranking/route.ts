...
export type StockRankItem = {
  ...
  foreign_net_qty: unknown;
  institution_net_qty: unknown;
  foreign_net_5d: unknown;
  institution_net_5d: unknown;
  foreign_streak: unknown;
  institution_streak: unknown;
  short_sell_ratio: unknown;
  high_52w: unknown;
  low_52w: unknown;
  forward_per: unknown;
  target_price: unknown;
  invest_opinion: unknown;
  signal_count_30d: unknown;
  latest_signal_type: unknown;
  latest_signal_date: unknown;
  latest_signal_price: unknown;
  is_managed: unknown;
  volume: unknown;
  prices_updated_at: unknown;
};
